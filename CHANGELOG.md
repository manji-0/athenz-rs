...
- Feat: added ZMS domain template apply/list/remove endpoints
...
- Breaking: JwtValidationOptions adds required_spec_claims; struct literal initializers must include the new field (prefer constructor helpers).

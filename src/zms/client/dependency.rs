...
impl ZmsClient {
    ...
    pub fn delete_domain_dependency(
        &self,
        domain_name: &str,
        service: &str,
        audit_ref: Option<&str>,
    ...
    pub fn get_dependent_service_list(
        &self,
        domain_name: &str,
    ...
    pub fn get_dependent_service_resource_group_list(
        &self,
        domain_name: &str,
    ...
    pub fn get_dependent_domain_list(&self, service: &str) -> Result<DomainList, Error> {

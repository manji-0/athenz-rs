...
impl ZmsAsyncClient {
    ...
    pub async fn put_assertion_policy_version(
        &self,
        domain: &str,
        policy: &str,
        version: &str,
    ...
    pub async fn put_assertion_conditions(
        &self,
        domain: &str,
        policy: &str,
        assertion_id: i64,
    ...
    pub async fn put_assertion_condition(
        &self,
        domain: &str,
        policy: &str,
        assertion_id: i64,
    ...
    pub async fn delete_assertion_policy_version(
        &self,
        domain: &str,
        policy: &str,
        version: &str,
    ...
    pub async fn delete_assertion_conditions(
        &self,
        domain: &str,
        policy: &str,
        assertion_id: i64,
    ...
    pub async fn delete_assertion_condition(
        &self,
        domain: &str,
        policy: &str,
        assertion_id: i64,
